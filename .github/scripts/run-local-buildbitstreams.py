...
GH_REPO = 'your repo'
GH_ORG = 'your github it'
URL_PREFIX = f"https://raw.githubusercontent.com/{GH_ORG}/{GH_REPO}"
PERSONAL_ACCESS_TOKEN='github personal token'
...
def run_local_buildbitstreams():
    ...
    with prefix(f"cd {manager_fsim_dir}"):
        ...
        with prefix('source sourceme-manager.sh --skip-ssh-setup'):
            ...
            hosts = {
                ("localhost", "vivado:2021.1"),
                ("firesim1",  "vivado:2021.1"),
                ("jktgz",     "vivado:2021.1"),
            ...
            batch_hwdbs_in = [
                ("xilinx_u250_firesim_rocket_soc_preserve",  "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_rocket_tile_preserve", "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_rocket_split_soc",       "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_rocket_split_tile",      "xilinx_alveo_u250", "vivado:2021.1")
            ]
            do_builds(batch_hwdbs_in)

            batch_hwdbs_in = [
                ("xilinx_u250_firesim_small_boom_soc",     "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_small_boom_backend", "xilinx_alveo_u250", "vivado:2021.1")
            ]
            do_builds(batch_hwdbs_in)

            batch_hwdbs_in = [
                ("xilinx_u250_eight_rocket_mesh_0", "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_eight_rocket_mesh_1", "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_eight_rocket_mesh_2", "xilinx_alveo_u250", "vivado:2021.1")
            ]
            do_builds(batch_hwdbs_in)

            batch_hwdbs_in = [
                ("xilinx_u250_firesim_hyperscale_client_1",    "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_hyperscale_client_0",    "xilinx_alveo_u250", "vivado:2021.1"),
                ("xilinx_u250_firesim_hyperscale_client_base", "xilinx_alveo_u250", "vivado:2021.1")
            ]
            do_builds(batch_hwdbs_in)
