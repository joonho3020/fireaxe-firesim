...
from runtools.simulation_data_classes import TipTracingConfig, TracerVConfig, AutoCounterConfig, HostDebugConfig, SynthPrintConfig, PartitionConfig
...
class FireSimTopologyWithPasses:
    ...
    defaulttiptracingconfig: TipTracingConfig
    ...
    def __init__(self,
        ...
        self.defaulttiptracingconfig = defaulttiptracingconfig
    ...
    def pass_simple_networked_partitioned_host_node_mapping(self) -> None:
        ...
        inst_handle_for_servers = self.run_farm.get_smallest_sim_host_handle(num_sims=len(servers))
    ...
    def pass_apply_default_params(self) -> None:
        ...
        for node in allnodes:
            ...
            if isinstance(node, FireSimServerNode):
                ...
                if node.tiptracing_config is None:
                    node.tiptracing_config = self.defaulttiptracingconfig
